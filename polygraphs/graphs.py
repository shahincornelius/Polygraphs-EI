...
def complete_grouped_(size, groups, selfloop=True):
    ...
    # Shuffle the nodes
    # To do: Link to seed specified in parameters
    ...
    # Assign each node a group label
    ...
    # Add group labels as a graph feature
...
def complete_grouped(params):
    """
    Returns a grouped, undirected fully-connected graph from hyper-parameters.
    """
    return complete_grouped_(params.size, params.groups, selfloop=params.selfloop)